...
export const Bjuguetes = ({navigation}: Props) => {
  ...
  return (
    <View style={styles.globalMargin}>
      <Text style={styles.title}>ver AUTO </Text>

      <Image
        source={require('../../imagenes/juguetes.jpg')}
        style={styles.imach}
      />

      <Text style={styles.TRANSPORTE}>ETE ARTIUCLO CUESTA $150</Text>
